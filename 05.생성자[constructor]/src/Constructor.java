...
public class Constructor {
	...
	// 생성자 메쏘드 : 객체 생성 후, 최초로 단 한번 호출되는 메쏘드
	//주로 객체멤버필드 초기화의 용도로 사용한다.
	public Constructor() {
		//생성자메쏘드안에서는 생성된객체의 self참조변수 this 를 사용할수 있다.
	...
	public Constructor(int member1, int member2, String member3) {
		System.out.println("Constructor(int member1, int member2, String member3) 생성자 호출 : " + this);
