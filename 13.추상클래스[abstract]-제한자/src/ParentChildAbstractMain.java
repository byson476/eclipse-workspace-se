...
abstract class Parent{
	public void method1() {
		System.out.println("Parnet.method1() 난 구상(concrete)메쏘드");
	}
...
class Child extends Parent{
	...
	@Override
	public void method2() {
		System.out.println("Child에서Parent의 추싱메쏘드 method2 재정의[implement, specified]");
		
	}
	
}

public class ParentChildAbstractMain {
